    ...
    class App {
      constructor(container, options = {}) {
        ...
        this.renderer.debug.onShaderError = (gl, program, vertexShader, fragmentShader) => {
          console.error("SHADER COMPILE ERROR Vertex:", gl.getShaderInfoLog(vertexShader));
          console.error("SHADER COMPILE ERROR Fragment:", gl.getShaderInfoLog(fragmentShader));
        };
